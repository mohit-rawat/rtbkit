...
/* pubnative_exchange_connector.h                                    -*- C++ -*-
...
/** Exchange connector for PubNative.  This speaks their flavour of the
    OpenRTB 2.3 protocol and native version 1.0
*/

	struct PubNativeExchangeConnector: public OpenRTBExchangeConnector {
		...
		/** This is the information that the PubNative exchange needs to keep
			for each campaign (agent).
		*/
		struct CampaignInfo {
			Id seat;          ///< ID of the PubNative exchange seat
		...
		/** This is the information that PubNative needs in order to properly
