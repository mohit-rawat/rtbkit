...
/** Exchange connector for Afmobi.  This speaks their flavour of the
    OpenRTB 2.4 protocol
*/

	struct AfmobiExchangeConnector: public OpenRTBExchangeConnector {
		...
		/** This is the information that the Afmobi exchange needs to keep
			for each campaign (agent).
		*/
		struct CampaignInfo {
			Id seat;          ///< ID of the Afmobi exchange seat
		...
		/** This is the information that Afmobi needs in order to properly
