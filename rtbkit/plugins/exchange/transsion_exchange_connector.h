/* transsion_exchange_connector.h                                    -*- C++ -*-
*/
...
/** Exchange connector for Transsion.  This speaks their flavour of the
    OpenRTB 2.5 protocol.
*/

struct TranssionExchangeConnector: public OpenRTBExchangeConnector {
    ...
    /** This is the information that the Transsion exchange needs to keep
        for each campaign (agent).
    */
    struct CampaignInfo {
        Id seat;          ///< ID of the Transsion exchange seat
    ...
    /** This is the information that Transsion needs in order to properly
    ...
    */
    ...
    // Transsion win price decoding function.
